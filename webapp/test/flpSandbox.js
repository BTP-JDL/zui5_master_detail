					...
					"config": {
						"inbounds": {
							"MasterDetail-display": {
								...
								"action": "display",
								"description": "Master Detail Template",
								"title": "Master Detail",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=co.com.jdl.zui5_master_detail",
									"url": sap.ui.require.toUrl("co/com/jdl/zui5_master_detail")
								}
							}
						}
					}
	...
	var oFlpSandbox = {
		init: function () {
			...
			if (!this._oBootstrapFinished) {
				...
				this._oBootstrapFinished.then(async function () {
